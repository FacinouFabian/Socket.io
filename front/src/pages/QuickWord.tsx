...
import { Word } from '../core/components'
...
export default function MagicNumber(): JSX.Element {
    ...
    const [serverMessage, setServerMessage] = useState<QuickWordResult>()
    ...
    const sendWord = (): void => {
        io.emit('game::userQuickWord', { 
            roomId: game.id, 
            word: value, 
            nickname: user.nickname
        })

        io.on('game::isWord', (message: QuickWordResult) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <h1 className="absolute top-0 text-4xl font-bold">Socket Game (QuickWord)</h1>
            <div className="flex items-center justify-center">

                { game.isEnded === false ? <Word /> : '' }
